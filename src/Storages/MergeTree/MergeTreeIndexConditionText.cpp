    ...
    RPNElement & out) const
{
    ...
    if (function_name == "like")
    {
            ...
            && settings[Setting::use_text_index_like_evaluation_by_dictionary_scan])
        {
            ...
            if (patterns.size() == 1)
            {
                auto pattern_read_mode = isInfixPattern(like_pattern) ? TextIndexDirectReadMode::Exact : direct_read_mode;
        ...
        && settings[Setting::use_text_index_like_evaluation_by_dictionary_scan])
    {
        ...
        if (patterns.size() == 1)
        {
            ...
            auto pattern_read_mode = isInfixPattern(like_pattern) ? TextIndexDirectReadMode::Exact : getHintOrNoneMode();
